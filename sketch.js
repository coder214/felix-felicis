...
var balloonLeft, balloonRight, blow_s;
...
function preload() {
  ...
  blow_s = loadSound('air.wav');
  laugh_s = loadSound('laugh.mp3');
...
function draw() {
  ...
  if(weeds==null&&mushroom==null&&A_eggs==null&&horn==null&&ground!==null){
    wizard.changeAnimation('wizard_h');
    wizard.scale = 0.8;
    cauldron.changeAnimation('caul_f');
  }

  if(A_eggs!=null && A_eggs.position.y>=550)
  {
   ...
   if(horn!=null && horn.position.y>=550)
  {
    wizard.changeAnimation('wizard_s');
    wizard.scale = 0.8;
    horn=null;
   ...
   if(weeds!=null && weeds.position.y>=550)
  {
    wizard.changeAnimation('wizard_s');
    wizard.scale = 0.8;
    weeds=null;
   ...
   if(mushroom!=null && mushroom.position.y>=550)
  {
    wizard.changeAnimation('wizard_s');
    wizard.scale = 0.8;
    mushroom=null;
